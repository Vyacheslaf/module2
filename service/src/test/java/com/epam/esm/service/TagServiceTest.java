...
public class TagServiceTest {
    ...
    private static Dao<Tag> mockDao;
    ...
    public void createTest() throws DaoException, ServiceException {
        ...
        TagService tagService = new TagService(mockDao);
    ...
    public void updateTest() throws ServiceException {
        assertThrows(ServiceUnsupportedOperationException.class, () -> new TagService(mockDao).update(new Tag()));
    }
}
